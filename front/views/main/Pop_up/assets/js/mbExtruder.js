...
(function($) {
  ...
  $.mbExtruder= {
    ...
    buildMbExtruder: function(options){
      return this.each (function (){
        ...
        extruderStyle=
          ...
          {position:position,top:0,left:"50%",marginLeft:-this.options.width/2,width:this.options.width}: // TODO Lookout for these in case of update
            this.options.position=="bottom"?
            {position:position,bottom:0,left:"50%",marginLeft:-this.options.width/2,width:this.options.width}:// TODO Lookout for these in case of update
    ...
    openMbExtruder:function(c, userSuppressed){
      var extruder= $(this);
      if(userSuppressed == null){
  		extruder.removeClass('userSuppressed');
      }
    ...
    closeMbExtruder:function(userSuppressed){
      var extruder= $(this);
    	if(userSuppressed == null){
    		extruder.addClass('userSuppressed');
    	}
      extruder.removeAttr("isOpened");
      var opt= extruder.get(0).options;
