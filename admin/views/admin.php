                        ...
                        <td>
                            <select 
                                ...
                                >
                                    ...
                                    <option value="0.002" <?php selected($erpPROOptions['entropy'], 0.002) ?>>Mix result a bit</option>
                                    <option value="0.3" <?php selected($erpPROOptions['entropy'], 0.3) ?>>Almost random!</option>
